...
| 13   | 15.12.2021  | Parsing with Combinators / Lambda Calculus  | Parsing with Combinators ([Video][Video 3.2.1], [Slides][Slides 3.2.1])<br/>Recursion as Self-Application ([Video][Video 3.2.2], [Slides][Slides 3.2.2])<br/>Church Numerals and Conditionals ([Video][Video 3.2.3], [Slides][Slides 3.2.3]) |
